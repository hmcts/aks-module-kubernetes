...
variable "node_os_maintenance_window_config" {
  ...
  validation {
    ...
    //var.node_os_maintenance_window_config.frequency == "Weekly" && try(contains(["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], var.node_os_maintenance_window_config.day_of_week), false)
