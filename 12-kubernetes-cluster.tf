...
resource "azurerm_kubernetes_cluster" "kubernetes_cluster" {
  ...
  kubelet_identity {
    client_id                 = var.kubelet_uami_enabled ? data.azurerm_user_assigned_identity.kubelet_uami[0].client_id : []
    user_assigned_identity_id = var.kubelet_uami_enabled ? data.azurerm_user_assigned_identity.kubelet_uami[0].object_id : []
  }
