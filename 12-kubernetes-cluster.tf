...
resource "azurerm_kubernetes_cluster" "kubernetes_cluster" {
  ...
  lifecycle {
    ...
    precondition {
      condition     =  var.enable_node_os_channel_upgrade_nodeimage != true && var.node_os_maintenance_window_duration >= 4 && var.var.node_os_maintenance_window_duration != null
