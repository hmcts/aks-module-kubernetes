...
resource "azurerm_kubernetes_cluster" "kubernetes_cluster" {
  ...
  dynamic "maintenance_window_node_os" {
    ...
    content {
      ...
      start_time = var.enable_node_os_channel_upgrade_nodeimage ? (tonumber(substr(var.node_os_maintenance_window_config.start_time, 0, 2)) > 23
        ) || (tonumber(substr(var.node_os_maintenance_window_config.start_time, 0, 2)) < 6
      ) : var.node_os_maintenance_window_config.start_time
